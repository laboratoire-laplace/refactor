...
const AGENT_ID = process.env.CURRENT_AGENT_ID || "agent-5";
setCurrentAgentId(AGENT_ID);

const config = {
  id: AGENT_ID,
  googleApiKey: process.env.AGENT5_API_KEY || process.env.GOOGLE_API_KEY,
  starknetConfig: {
    rpcUrl: process.env.STARKNET_RPC_URL!,
    address: process.env.AGENT5_ADDRESS!,
    privateKey: process.env.AGENT5_PRIVATE_KEY!,
  }
}
